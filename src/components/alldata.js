...
export default function Alldata() {
  ...
  async function fetchData() {
    let result = await axios.get("https://bank-server-jiie.onrender.com/data");
    setData(result.data);
  }

  async function handleDelete(id) {
    await axios.delete(`https://bank-server-jiie.onrender.com/delete/${id}`);
    fetchData();
  }
  ...
  async function handleUpdate(e) {
    e.preventDefault();
    await axios.put(`https://bank-server-jiie.onrender.com/update/${editId}`, editUser);
    setEditId(null);
    fetchData();
  }
